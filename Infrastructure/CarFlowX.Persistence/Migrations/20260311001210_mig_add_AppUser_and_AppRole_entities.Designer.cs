...
namespace CarFlowX.Persistence.Migrations
{
    ...
    [Migration("20260311001210_mig_add_AppUser_and_AppRole_entities")]
    partial class mig_add_AppUser_and_AppRole_entities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.About", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.AppRole", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.AppUser", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.Banner", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.Car", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.CarDescription", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.CarFeature", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.CarPricing", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.Feature", b =>
                {
                    b.Property<int>("FeatureId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.FooterAddress", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.Location", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.Pricing", b =>
                {
                    b.Property<int>("PricingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.RentACar", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.RentACarProcess", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.Reservation", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.Review", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.Service", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.SocialMedia", b =>
                {
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.AppUser", b =>
                {
                    b.HasOne("CarFlowX.Domain.Entities.AppRole", "AppRole")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.Blog", b =>
                {
                    b.HasOne("CarFlowX.Domain.Entities.Author", "Author")
                        .WithMany("Blogs")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarFlowX.Domain.Entities.Category", "Category")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.Car", b =>
                {
                    b.HasOne("CarFlowX.Domain.Entities.Brand", "Brand")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.CarDescription", b =>
                {
                    b.HasOne("CarFlowX.Domain.Entities.Car", "Car")
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.CarFeature", b =>
                {
                    ...
                    b.HasOne("CarFlowX.Domain.Entities.Feature", "Feature")
                        .WithMany("CarFeatures")
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.CarPricing", b =>
                {
                    ...
                    b.HasOne("CarFlowX.Domain.Entities.Pricing", "Pricing")
                        .WithMany("CarPricings")
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.RentACar", b =>
                {
                    ...
                    b.HasOne("CarFlowX.Domain.Entities.Location", "Location")
                        .WithMany("RentACars")
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.RentACarProcess", b =>
                {
                    ...
                    b.HasOne("CarFlowX.Domain.Entities.Customer", "Customer")
                        .WithMany("RentACarProcesses")
            ...
            modelBuilder.Entity("CarFlowX.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.HasOne("CarFlowX.Domain.Entities.Location", "DropOffLocation")
                        .WithMany("DropOffReservation")
                        .HasForeignKey("DropOffLocationId");

                    b.HasOne("CarFlowX.Domain.Entities.Location", "PickUpLocation")
