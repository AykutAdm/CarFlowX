using CarFlowX.Application.Features.Mediator.Queries.StatisticsQueries;
using CarFlowX.Application.Features.Mediator.Results.StatisticsResults;
...
namespace CarFlowX.Application.Features.Mediator.Handlers.StatisticsHandlers
{
